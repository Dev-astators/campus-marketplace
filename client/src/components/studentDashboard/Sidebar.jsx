...
export default function Sidebar({ activeItem = "marketplace", onNavigate, unreadCount = 0 }) {
  return (
    <aside className="h-full border-r border-gray-200 bg-white px-3 pt-6">
              ...
              <li key={item.key}>
                ...
                >
                  <figure className="relative">
                    {item.icon}
                    {showBadge ? (
                      <mark className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-[9px] font-bold text-white">
