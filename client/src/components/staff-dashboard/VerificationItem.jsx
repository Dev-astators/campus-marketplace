...
export default function VerificationItem({
  ...
  return (
    <li className="px-5 py-4 border-b border-slate-100 last:border-b-0 hover:bg-slate-50 transition-colors duration-150">
      {/* Item row */}
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <span
            className={`inline-block text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded mb-1.5 ${priorityStyles[priority]}`}
          >
            {priorityLabel}
          </span>
...
function VerifiedState() {
  return (
    <div className="flex items-center gap-2 py-1">
      ...
      <span className="text-[11.5px] text-green-600 font-semibold">
        Item verified
      </span>
    </div>
  );
