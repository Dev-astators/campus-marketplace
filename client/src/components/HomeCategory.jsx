const CATEGORIES = [
  {
    ...
    description:
      "Save up to 70% on this semester's required reading from students who just finished.",
    ...
    overlayClass:
      "bg-gradient-to-r from-[#1a3a3a]/90 via-[#1a3a3a]/60 to-transparent",
  },
  {
    id: "tech",
    ...
    imagePosition: "object-center",
    overlayClass:
      "bg-gradient-to-br from-[#0d1f2d]/80 via-[#0d1f2d]/60 to-transparent",
  },
  {
    id: "dorm",
    ...
    gridClass: "col-span-1 row-span-1",
    imageUrl:
      "https://tse4.mm.bing.net/th/id/OIP.VHU4Gq5KHcx4OBY49_SExQHaLG?rs=1&pid=ImgDetMain&o=7&rm=3",
    imagePosition: "object-top",
    overlayClass:
      "bg-gradient-to-t from-[#0d1f2d]/90 via-[#0d1f2d]/40 to-transparent",
  },
  {
    id: "furniture",
    ...
    imagePosition: "object-center",
    overlayClass:
      "bg-gradient-to-r from-[#1a3a3a]/80 via-[#1a3a3a]/50 to-transparent",
  },
];
...
function CategoryCard({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <header className="relative z-10 flex flex-col justify-end h-full p-7">
        <h3 className="text-white font-['inter',sans-serif] font-bold text-2xl leading-tight mb-1">
          {title}
        </h3>
        {description && (
          <p className="text-white/70 font-['inter',sans-serif] text-sm leading-relaxed mb-4 max-w-xs">
            {description}
          </p>
        )}
