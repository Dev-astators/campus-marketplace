...
const BG = "https://images.istockphoto.com/id/1390233984/photo/university-students-walking-on-campus.jpg?s=1024x1024&w=is&k=20&c=placeholder";

export default function UniversitySquare() {
      const handleGoogle = () => {
  ...
  return (
    <section style={{ display: "flex", height: "100vh", fontFamily: "sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, letterSpacing: 1, opacity: 0.7 }}>UNIVERSITY SQUARE</div>
        ...
        <div style={{ display: "flex", gap: "2rem", fontSize: 11, letterSpacing: 1, opacity: 0.6 }}>
          <span>UNIVERSITY SQUARE © 2024</span>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: 13, color: "#555", margin: "0 0 1.5rem" }}>
            ...
            <a href="#" style={{ color: "#1a56db", fontWeight: 600, textDecoration: "none" }}>Sign In</a>
          </p>
