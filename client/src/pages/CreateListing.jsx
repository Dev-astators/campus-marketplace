    ...
    >
      <section className="mx-auto max-w-4xl">
        ...
        <form
          ...
          className="space-y-6 rounded-3xl border border-gray-200 bg-white/90 p-6 shadow-sm backdrop-blur sm:p-8"
        >
            ...
            <section className="space-y-2">
              ...
              <article className="rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-5">
                ...
                <p className="mt-4">
                  <label
                    htmlFor="listing-image"
                    className="inline-flex cursor-pointer rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-blue-700"
                  >
                    Choose image
                  </label>
                </p>
