...
describe("AdminDashboard", () => {
  ...
  const baseDashboard = {
    ...
    operatingHours: [{ day: "Mon", open: "08:00", close: "18:00", active: true }],
  ...
  beforeEach(() => {
    useAdminDashboard.mockReturnValue(baseDashboard);
  });
  ...
  it("renders the profile section when active", () => {
    ...
    expect(screen.queryByText(/overview of marketplace/i)).not.toBeInTheDocument();
  });

  it("shows loading states and error banner", () => {
    useAdminDashboard.mockReturnValueOnce({
      ...baseDashboard,
      loadingStates: {
        summary: true,
